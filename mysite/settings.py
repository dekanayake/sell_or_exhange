...
SEARCH_PAGINATION_SIZE = 5

GOOGLE_MAP_API_RESUORCE_URL = 'https://maps.googleapis.com/maps/api/geocode/json'
GOOGLE_MAP_API_KEY='AIzaSyANH3ZtDyL8BnbMQCp7Yzyoz19Fj_cWAvU'
GOOGLE_MAP_API_SEARCH_COUNTRY_CODE = 'LK'
